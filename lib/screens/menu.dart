...
import 'package:football_store/widgets/products_card.dart';

class MyHomePage extends StatelessWidget {
    MyHomePage({super.key});

    final String nama = "Josiah Naphta Simorangkir"; //nama
    ...
    @override
      ...
      appBar: AppBar(
        // Judul aplikasi "Football Store" dengan teks putih dan tebal.
        title: const Text(
          'Football Store',
          style: TextStyle(
            color: Colors.white,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Football Store',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
